...
int cam_sensor_match_id(struct cam_sensor_ctrl_t *s_ctrl)
{
    ...
    switch (slave_info->sensor_id)
    {
        case 0x487b://8Mrgb lce 0x0a
            if (!(0x01 & module_flag)){
                register_hardware_info("cameraFront1","txd_s5k4h7");
                module_flag = 0x01 | module_flag;
            }
            break;
        case 0x885a://8Mrgb
            if (!(0x01 << 1 & module_flag)){
                register_hardware_info("cameraFront1","qtech_ov8856");
                module_flag = 0x01<<1 | module_flag;
            }
            break;
        case 0x559b://5M ofilm 0x07
            if (!( 0x01 << 2 & module_flag)){
                register_hardware_info("camerarear2","ofilm_s5k5e9yx04");
        ...
        case 0x5035://5M kingcome
            if (!(0x01 << 5 & module_flag)){
                register_hardware_info("cameraRear2","lce_gc5035");
                module_flag = 0x01 << 5 | module_flag;
            }
            break;
        case 0x0d43://13M txd
            if (!(0x01 << 6 & module_flag)){
                register_hardware_info("cameraRear1","txd_ov13b10");
